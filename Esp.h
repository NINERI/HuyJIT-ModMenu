...
void DrawSkeleton(void* player, ImColor color) {
	if (GetPlayerTeam(player) != GetPlayerTeam(me)) {
		...
		bool HeadChecker;
		ImVec2 HeadPosFixed = world2screen_c(HeadPos, HeadChecker);
		
		Vector3 HeadUpPos = Vector3(get_position(aimedPlayerHead).x, get_position(aimedPlayerHead).y + 0.3f,
								  get_position(aimedPlayerHead).z);
		bool HeadUpChecker;
		ImVec2 HeadUpPosFixed = world2screen_c(HeadUpPos, HeadUpChecker);
		...
		bool NeckChecker;
		ImVec2 NeckPosFixed = world2screen_c(NeckPos, NeckChecker);
		...
		bool Spine2Checker;
		ImVec2 Spine2PosFixed = world2screen_c(Spine2Pos, Spine2Checker);
		...
		bool Spine1Checker;
		ImVec2 Spine1PosFixed = world2screen_c(Spine1Pos, Spine1Checker);
		...
		bool HipChecker;
		ImVec2 HipPosFixed = world2screen_c(HipPos, HipChecker);
		...
		ImVec2 LeftShouldPosFixed = world2screen_c(LeftShouldPos, LeftShouldChecker);
		...
		ImVec2 RightShouldPosFixed = world2screen_c(RightShouldPos, RightShouldChecker);
		...
		ImVec2 LeftUpperPosFixed = world2screen_c(LeftUpperPos, LeftUpperChecker);
		...
		ImVec2 RightUpperPosFixed = world2screen_c(RightUpperPos, RightUpperChecker);
		...
		ImVec2 LeftForePosFixed = world2screen_c(LeftForePos, LeftForeChecker);
		...
		ImVec2 RightForePosFixed = world2screen_c(RightForePos, RightForeChecker);
		...
		ImVec2 LeftHandPosFixed = world2screen_c(LeftHandPos, LeftHandChecker);
		...
		ImVec2 RightHandPosFixed = world2screen_c(RightHandPos, RightHandChecker);
		...
		bool LeftThiChecker;
		ImVec2 LeftThiPosFixed = world2screen_c(LeftThiPos, LeftThiChecker);
		...
		ImVec2 RightThiPosFixed = world2screen_c(RightThiPos, RightThiChecker);
		...
		ImVec2 LeftCalfPosFixed = world2screen_c(LeftCalfPos, LeftCalfChecker);
		...
		ImVec2 RightCalfPosFixed = world2screen_c(RightCalfPos, RightCalfChecker);
		...
		ImVec2 LeftFootPosFixed = world2screen_c(LeftFootPos, LeftFootChecker);
		...
		ImVec2 RightFootPosFixed = world2screen_c(RightFootPos, RightFootChecker);
...
void DrawEsp() {
		if (espen) {
                ...
                const char *armorCString = [armorString UTF8String];
										...
										if (espbox) {
											if (espfill) {
												getDrawList() ->AddRectFilled(
																ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4), w2sTop.y / 2), 
																ImVec2(pmtXbottom / 2 + fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4), w2sTop.y / 2 + espround),
												...
												getDrawList() ->AddRectFilledMultiColor(
																ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4), w2sTop.y / 2 + espround),
																ImVec2(pmtXbottom / 2 + fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4), w2sBottom.y / 2 - espround),
																ImColor((int) (color.x * 255),
																				(int) (color.y * 255),
																				(int) (color.z * 255),
																				(int) ((float) (espgradient ? 10 : 80) * (float) espfillp / 100.0f)),
																...
																ImColor((int) (color.x * 255),
																				...
																				(int) (80.0f * (float) espfillp / 100.0f)));
												getDrawList() ->AddRectFilled(
																ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4), w2sBottom.y / 2 - espround),
																ImVec2(pmtXbottom / 2 + fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4), w2sBottom.y / 2),
																ImColor((int) (color.x * 255),
																				(int) (color.y * 255),
																				(int) (color.z * 255),
																				(int) (80.0f * (float) espfillp / 100.0f)),
											...
											if (esphpoutline) {
					                          ...
					                          getDrawList() ->AddRect(
					                                  ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) - 1 - espstroke / 2, w2sTop.y / 2 - 1 - espstroke / 2),
					                                  ImVec2(pmtXbottom / 2 + fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) + 1 + espstroke / 2, w2sBottom.y / 2 + 1 + espstroke / 2),
                      ...
                      getDrawList()->AddLine(
                          ImVec2(pmtXbottom / 2 + fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) + (esphpsize / 2) + 6 - 1, w2sBottom.y / 2),
                          ImVec2(pmtXbottom / 2 + fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) + (esphpsize / 2) + 6 - 1, lerp(w2sBottom.y / 2, w2sTop.y / 2, armorL / 100.0f)),
                          armorcolor, esphpsize);

                      if (esphpoutline) {
                        getDrawList() ->AddRect(
                                ImVec2(pmtXbottom / 2 + fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) + esphpsize + 6, w2sTop.y / 2 - 1),
                                ImVec2(pmtXbottom / 2 + fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) + 6 - 1, w2sBottom.y / 2 + 2),
                      ...
                      if (armor < 100 || armor > 100) {
                          if (esphpoutline) {
                            getDrawList() ->AddText(
                                    ...
                                    lerp(w2sBottom.y / 2, w2sTop.y / 2, armorL / 100.0f) - ImGui::CalcTextSize(armorCString).y / 2 - 1),
                          ...
                          getDrawList() ->AddText(
                                  ...
                                  lerp(w2sBottom.y / 2, w2sTop.y / 2, armorL / 100.0f) - ImGui::CalcTextSize(armorCString).y / 2),
                                  ImColor(255, 255, 255), armorCString);
										...
										if (esphealth) {
											getDrawList() ->AddLine(
															ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) - (esphpsize / 2) - 6, w2sBottom.y / 2 ),
															ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) - (esphpsize / 2) - 6, w2sTop.y / 2),
															ImColor(0, 0, 0, 120), esphpsize);

											if (esphpoutline) {
												getDrawList() ->AddRect(
																ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) - esphpsize - 6 - 1, w2sTop.y / 2 - 1),
																ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) - 6 + 2, w2sBottom.y / 2 + 2),
																ImColor(0, 0, 0, 200), 0, 0, 1);
											}
											...
											if (!esphpgradient) {
												getDrawList() ->AddLine(
																...
																lerp( w2sBottom.y / 2, w2sTop.y / 2, healthL / 100.0f)),hpcolor, esphpsize);
											} else {
												getDrawList() ->AddRectFilledMultiColor(
																ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) - (esphpsize / 2) - 6 - esphpsize / 2, w2sBottom.y / 2),
																ImVec2(pmtXtop / 2 - fabs((w2sTop.y - w2sBottom.y) * (0.0092f / 0.019f) / 4) - (esphpsize / 2) - 6 + esphpsize / 2,
																lerp( w2sBottom.y / 2, w2sTop.y / 2, healthL / 100.0f)), minhpcolor, minhpcolor, hpcolor, hpcolor);
											}
											...
											if (health < 100 || health > 100) {
													if (esphpoutline) {
														getDrawList() ->AddText(
																		...
																		lerp( w2sBottom.y / 2, w2sTop.y / 2, healthL / 100.0f) - ImGui::CalcTextSize(healthCString).y / 2 - 1),
													...
													getDrawList() ->AddText(
																	...
																	lerp( w2sBottom.y / 2, w2sTop.y / 2, healthL / 100.0f) - ImGui::CalcTextSize(healthCString).y / 2),
										...
										if (espname) {
											if (esphpoutline) {
												getDrawList() ->AddText(
																...
																(ImGui::GetFontSize() + esphptextsize)) / 2 - 1, w2sTop.y / 2 -
												...
												getDrawList() ->AddText(
																...
																ImVec2((pmtXtop / 2 + (pmtXbottom / 2 - pmtXtop / 2) / 2) -
																((ImGui::CalcTextSize(name.c_str()).x / ImGui::GetFontSize()) *
																(ImGui::GetFontSize() + esphptextsize)) / 2, w2sTop.y / 2 -
																((ImGui::CalcTextSize(name.c_str()).y / ImGui::GetFontSize()) *
										...
										if (espweapon) {
											if (esphpoutline) {
												getDrawList() ->AddText(
																...
																(ImGui::GetFontSize() + esphptextsize)) / 2 - 1, w2sBottom.y / 2 + 2 - 1),
												...
												getDrawList() ->AddText(
																...
																ImVec2((pmtXtop / 2 + (pmtXbottom - pmtXtop) * (0.0092f / 0.019f) / 2) -
																((ImGui::CalcTextSize(wpn.c_str()).x / ImGui::GetFontSize()) *
																(ImGui::GetFontSize() + esphptextsize)) / 2, w2sBottom.y / 2 + 2),
